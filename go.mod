...
require (
	...
	github.com/skip-mev/block-sdk v1.3.0-alpha.1.0.20240102183529-95436d1b2ad0
...
replace (
	...
	// https://github.com/osmosis-labs/cosmos-sdk/releases/tag/v0.47.5-osmo-3
	github.com/cosmos/cosmos-sdk => github.com/osmosis-labs/cosmos-sdk v0.47.5-osmo-3
